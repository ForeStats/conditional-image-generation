...
def generate_images(
    ...
    python generate_class.py --outdir=../storage/out --seeds=10000 --class=0 \
        --network=training-runs/network-conditional.pkl
    ...
    np.savetxt(f'{outdir}/z_array_class{class_idx}.csv', z_array, delimiter = ",", header = ','.join(['X' + str(i) for i in range(seeds)]))
